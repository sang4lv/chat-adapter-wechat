---
"chat-adapter-wechat": minor
---

ACP mode: crash resilience, multi-bot gateways, split scan/polling.

**Crash resilience.** The ACP adapter now durably persists every message
in a `getupdates` batch to the chat-sdk state queue *before* advancing
